class Animation {
  ...
  //return { top: a.top - b.top, left: a.left - b.left };
    ...
    $(".animateMe").each(function(){
        ...
        //This is always the last line of the function
    ...
    playAnimation(target) 
    {
        ...
        var chain = $el.attr('data-chain') || null;
        ...
        // inside your playAnimation method
        var onEnd = (ev) => {
            if (ev && ev.originalEvent && !/^(transform|opacity)$/.test(ev.originalEvent.propertyName)) return;

            $el.off('transitionend', onEnd);
            $el.css({ transitionProperty:'', transitionDuration:'', transitionTimingFunction:'', transitionDelay:'' });
